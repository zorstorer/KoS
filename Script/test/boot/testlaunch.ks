...
when ship:verticalspeed > 100  then {
    ...
    print "Initiate pitch program. Starting at 85 deg.".
}.
when ship:verticalspeed > 175 then {
    lock steering to heading (90,80).
    print "Pitch over to 80 deg.".
}.
when ship:verticalspeed > 250 then {
    lock steering to heading (90,75).
    print "Pitch over to 75 deg.".
}.
