...
print "Launch".
lock throttle to 1.
lock steering to heading(350,90).
stage.
...
lock steering to heading(350,85).
print "" + time.
...
wait until ship:verticalspeed>125.
    ...
    wait 1.
    print "68 deg pitch.".
    lock steering to heading(350,68).
    print "" + time.   }
...
//     set oldThrust to ship:availablethrust.
//   }
lock steering to heading (350,60).
wait until ship:altitude>10000.

set oldThrust to ship:avaiLablethrUST.
print "The thrust is " +round(ship:availablethrust,2)+ " k/N.".
lock steering to heading(350,42).
lock throttle to .9.
